...
import { createNewPayment } from '../../service/adminService';
import { updatePayment } from '../../service/adminService';
...
const ModalProduct = (props) => {
    ...
    const fetGroup = async () => {
        let response = await fetchAllPayment()
    ...
    const handleSave = async (userData) => {
        ...
        if (check === true) {
            ...
            let res = props.action === 'Create' ? await createNewPayment({ ...userData })
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title id="contained-modal-title-vcenter">
                        {props.action === 'Create' ? 'Create New Payment' : "Edit Curent Payment"}
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>

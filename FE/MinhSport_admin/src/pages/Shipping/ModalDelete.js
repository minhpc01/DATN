        ...
        <>
            ...
            <Modal show={props.isShowModalDelete} onHide={props.handleCloseModalDelete}>
                <Modal.Header closeButton>
                    <Modal.Title>Confirm delete Shipping</Modal.Title>
                </Modal.Header>
                <Modal.Body>Woohoo, Are you confirm delete this shipping: {props.dataModalDelete ? props.dataModalDelete.name : ''}</Modal.Body>
                <Modal.Footer>
